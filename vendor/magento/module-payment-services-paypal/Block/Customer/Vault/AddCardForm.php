...
class AddCardForm extends \Magento\Framework\View\Element\Template
{
    ...
    public function getComponentParams(): array
    {
        ...
        return [
            ...
            'paymentsSDKFallbackUrl' => $sdkParams[PaymentsSDKConfigProvider::KEY_SDK_FALLBACK_URL],
            ...
            'isGuestCustomer'        => $sdkParams[PaymentsSDKConfigProvider::KEY_IS_GUEST_CUSTOMER],
            'commerceVersion'        => $sdkParams[PaymentsSDKConfigProvider::KEY_COMMERCE_VERSION],
        ];
    }
}
