...
use Magento\PaymentServicesPaypal\Api\Data\PaymentCardDetailsWithAuthenticationResultInterface;

/**
 * Class Payment Address
 */
class PaymentCardDetails extends DataObject implements PaymentCardDetailsWithAuthenticationResultInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        return $this->getData(self::AUTHENTICATION_RESULT);
    }
    ...
    {
        return $this->setData(self::AUTHENTICATION_RESULT, $authenticationResult);
    }
}
