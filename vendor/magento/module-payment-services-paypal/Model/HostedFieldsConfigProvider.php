...
class HostedFieldsConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $config['payment'][self::CODE]['paymentsSDKUrl'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_SDK_URL];
        $config['payment'][self::CODE]['paymentsSDKFallbackUrl'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_SDK_FALLBACK_URL];
        $config['payment'][self::CODE]['storeViewCode'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_STORE_VIEW_CODE];
        $config['payment'][self::CODE]['oauthToken'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_OAUTH_TOKEN];
        $config['payment'][self::CODE]['graphQLEndpointUrl'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_GRAPHQL_ENDPOINT_URL];
        $config['payment'][self::CODE]['isGuestCustomer'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_IS_GUEST_CUSTOMER];
        $config['payment'][self::CODE]['commerceVersion'] =
            $paymentsSDKParams[PaymentsSDKConfigProvider::KEY_COMMERCE_VERSION];
