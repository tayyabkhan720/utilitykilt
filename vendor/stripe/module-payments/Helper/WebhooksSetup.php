...
class WebhooksSetup
{
    ...
    {
        $automaticConfigurationEnabled = $this->scopeConfig->getValue('payment/stripe_payments_advanced_configuration/automatic_webhooks_configuration', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
