...
$product->setTypeId(Type::TYPE_SIMPLE)
    ...
    ->setStoreId($defaultStoreId)
    ->setWebsiteIds($defaultWebsiteIds)
    ->setName('Managed Simple Product')
    ->setSku('managed-simple-product')
    ->setPrice(10)
    ->setTaxClassId(2)
    ->setStockData([
...
$managedSimpleProduct = $productRepository->save($product);
...
$product->setTypeId(Type::TYPE_VIRTUAL)
    ...
    ->setStoreId($defaultStoreId)
    ->setWebsiteIds($defaultWebsiteIds)
    ->setName('Limited Virtual Product')
    ->setSku('limited-virtual-product')
    ->setPrice(10)
    ->setTaxClassId(2)
    ->setStockData([
        'use_config_manage_stock' => 0,
...
$limitedVirtualProduct = $productRepository->save($product);
