...
class SEPADebitPlaceOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPlaceOrder()
    {
        ...
        $invoice = $this->tests->stripe()->invoices->retrieve($initialOrderInvoiceId);
        ...
        // Stripe checks
        $paymentIntent = $this->tests->getPaymentIntentFromInvoiceId($initialOrderInvoiceId, ['expand' => ['latest_charge']]);
        $this->tests->compare($paymentIntent, [
            "latest_charge" => [
