 ...
 */
class FullDiscountCartOnceTest extends \PHPUnit\Framework\TestCase
{
    private $quote;
    private $tests;
     ...
     * @magentoDataFixture ../../../../app/code/StripeIntegration/Payments/Test/Integration/_files/Data/DiscountCartOnce.php
