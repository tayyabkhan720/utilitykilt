 ...
 */
class DiscountedShippingTest extends \PHPUnit\Framework\TestCase
{
    private $quote;
    private $tests;
    ...
    public function testDynamicBundleMixedTrialCart()
    {
        $this->quote->create()
            ...
            ->setCouponCode("10_percent_shipping")
            ->setPaymentMethod("SuccessCard");

        $quote = $this->quote->getQuote();
        $this->assertEquals(47.98, $quote->getGrandTotal());
