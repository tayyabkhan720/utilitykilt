 ...
 */
class OrderDateMixedCartTest extends \PHPUnit\Framework\TestCase
{
    private $compare;
    ...
    public function testPlaceOrder()
    {
        ...
        // Make sure that the new order amount does not include the initial fee and initial product
