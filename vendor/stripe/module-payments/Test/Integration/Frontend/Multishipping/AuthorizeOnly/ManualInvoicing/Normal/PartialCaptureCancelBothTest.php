 ...
 */
class PartialCaptureCancelBothTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testNormalCart()
    {
        ...
        // Partially capture order 1
        $invoice1 = $this->tests->invoiceOnline($order1, ['simple-product' => 1]);
