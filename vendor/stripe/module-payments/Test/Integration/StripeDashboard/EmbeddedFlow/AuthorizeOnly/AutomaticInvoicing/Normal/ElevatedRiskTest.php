...
class ElevatedRiskTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCancelation()
    {
        ...
        $this->assertEquals("The payment has been canceled by a Stripe Dashboard admin user with reason: Fraudulent.", $latestHistoryComment->getComment());
        // $this->assertEquals("closed", $latestHistoryComment->getStatus());
    }
}
