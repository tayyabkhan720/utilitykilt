 ...
 */
class SimpleProductAdjustmentPositiveNoMoneyAvailableTaxExclusiveTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTaxExclusive()
    {
        ...
        $this->expectExceptionMessage(sprintf('The most money available to refund is %s.', $order->getBaseCurrency()->formatTxt($orderGrandTotal)) );
