 ...
 */
class SimpleProductAdjustmentPositiveNoMoneyAvailableTaxInclusiveTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTaxInclusive()
    {
        ...
        $formattedTotal = $order->getBaseCurrency()->formatTxt($orderGrandTotal);
        $this->expectExceptionMessage(sprintf('The most money available to refund is %s.', $formattedTotal));
        $creditmemo = $this->tests->refundOnline($invoice, ['simple-product' => 2], $shipping, 5);
    }
}
