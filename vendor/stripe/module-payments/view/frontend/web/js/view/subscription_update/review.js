    ...
    function (
        ...
        return Component.extend({
            ...
            placeOrder: function()
            {
                ...
                // Do not set isLoading(true) before calling placeOrderAction, because blockLoader disables all inputs including the manual agreements checkbox,
                // which will cause an order placement failure.
            ...
            getData: function()
            {
                // Do not call agreementsAssigner() here. It is already called by the Magento place-order-mixin which wraps placeOrderAction.
                return {
