 ...
 */class RevertItemShippingTooHighTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTaxExclusive()
    {
        ...
        $this->assertStringContainsString('The amount specified for the shipping reversal is too high. Please provide a value less or equal to ', $tester->getDisplay());
