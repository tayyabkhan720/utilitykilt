 ...
 */
class SimpleProductSpecialPriceTaxInclusiveTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTaxInclusive()
    {
        ...
        $shipping = 10;
        $creditmemo = $this->tests->refundOffline($order, ['tax-simple-product-special-price' => 2], 8.26);
        $order = $this->orderHelper->refreshOrder($order);
