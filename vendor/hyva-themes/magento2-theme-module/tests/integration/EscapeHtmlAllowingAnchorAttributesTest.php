...
class EscapeHtmlAllowingAnchorAttributesTest extends TestCase
{
    ...
    public static function escapeHtmlExamples(): array
    {
        return [
            'allow-anchor' => [
                ...
                'expected' => 'This form is protected by reCAPTCHA - the <a class="underline" href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google Privacy Policy</a> and <a class="underline" href="https://policies.google.com/terms" target="_blank" rel="noopener">Terms of Service</a> apply.'
            ],
            'filter-div' => [
                ...
                'expected' => 'This form is protected by reCAPTCHA - the Google Privacy Policy and Terms of Service apply.'
            ],
            'filter-dummy-attrs' => [
                'input' => 'This link is <a href="#" foo="bar">very safe</a> - trust us!',
                'expected' => 'This link is <a href="#">very safe</a> - trust us!',
            ]
        ];
    }
}
