define([
    ...
    $.widget('amasty.checkoutFields', {
        options: {
            ...
            tabIndexNoFocus: -1,
            sortOrderStep: 10,
            immutableRequiredFieldNames: [
                'amcheckout-field-region',
                'amcheckout-field-postcode',
                'amcheckout-field-telephone'
            ],
            selectors: {
        ...
        handleUseDefaultCheckbox: function () {
            ...
            $(this.options.selectors.useDefaultCheckbox).change(function () {
                var $row = $(this).parents(self.options.selectors.tableRow),
                    fieldName = $row.find(self.options.selectors.fieldCell).prop('id');
                ...
                if (self.options.immutableRequiredFieldNames.indexOf(fieldName) === -1) {
