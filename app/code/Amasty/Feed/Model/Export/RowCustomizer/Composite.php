...
class Composite extends \Magento\CatalogImportExport\Model\Export\RowCustomizer\Composite
{
    ...
    public function init(ExportProduct $exportProduct)
    {
        ...
        $urlAttributes = $exportProduct->getAttributesByType(ExportProduct::PREFIX_URL_ATTRIBUTE);
        if (!isset($urlAttributes['configurable']) && !$exportProduct->hasParentAttributes()) {
