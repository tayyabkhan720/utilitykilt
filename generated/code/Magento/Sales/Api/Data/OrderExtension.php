...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
    ...
    /**
     * @return \Magento\Tax\Api\Data\OrderTaxInterface[]|null
     */
    ...
    /**
     * @param \Magento\Tax\Api\Data\OrderTaxInterface[] $taxes
     * @return $this
     */
    public function setTaxes($taxes)
    {
        $this->setData('taxes', $taxes);
        return $this;
    }
    ...
    {
        return $this->_get('additional_itemized_taxes');
    }

    /**
     * @param \Magento\Tax\Api\Data\OrderTaxItemInterface[] $additionalItemizedTaxes
     * @return $this
     */
