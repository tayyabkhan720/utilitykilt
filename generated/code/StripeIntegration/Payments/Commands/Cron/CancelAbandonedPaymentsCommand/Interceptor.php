...
class Interceptor extends \StripeIntegration\Payments\Commands\Cron\CancelAbandonedPaymentsCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\StripeIntegration\Payments\Helper\AreaCodeFactory $areaCodeFactory, \StripeIntegration\Payments\Cron\WebhooksPingFactory $webhooksPingFactory)
    {
        $this->___init();
        parent::__construct($areaCodeFactory, $webhooksPingFactory);
    }
