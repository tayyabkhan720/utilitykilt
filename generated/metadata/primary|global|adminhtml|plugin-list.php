<?php return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'sortOrder' => 0,
        'instance' => 'Hyva\\Theme\\Plugin\\Theme\\RemoveNoStoreHeaderPlugin',
      ),
    ),
    ...
    array (
      'mageworx_optionbase_api-methodsmap-replace-value-interface' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ReplaceProductOptionValueInterface',
      ),
    ),
    ...
    array (
      ...
      'mageworx_dynamic_options_save_price_scope_plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\DynamicOptionsBase\\Plugin\\UpdatePriceScopeOnConfigSavingPlugin',
      ),
    ),
    ...
    array (
      ...
      'mageworx-optionimportexport-fix-stock-import' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\FixStockImport',
      ),
    ),
    ...
    array (
      ...
      'mageworx_optiontemplates_is_require_checker_aftersave' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\IsRequireChecker',
      ),
    ),
    ...
    array (
      ...
      'mageworx-optionimportexport-set-import-entity-type' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\SetImportEntityType',
      ),
    ),
    ...
    array (
      ...
      'mageworx_optionbase_collect_product_conditions' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\CollectProductConditions',
      ),
      'mageworx_optionbase_extend_product_collection' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ExtendProductCollection',
      ),
    ),
    ...
    array (
      'mageworx_optionbase_api-get-product-repository' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Api\\Product\\GetProductAttributes',
      ),
      'mageworx_optionbase_api-set-product-repository' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Api\\Product\\SetProductAttributes',
      ),
    ),
    ...
    array (
      'mageworx-optionfeatures-around-get-option-price' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AroundGetOptionPrice',
      ),
    ),
    ...
    array (
      ...
      'beforeSaveImportedOptions' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\BeforeSaveImportedOptions',
      ),
      'mageworx_dynamic_options_duplicate_plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\DynamicOptionsBase\\Plugin\\Catalog\\Product\\DuplicatePlugin',
      ),
    ),
    ...
    array (
      ...
      'mageworx-optionfeatures-add-qty-multiplier-to-order' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AddQtyMultiplierToOrder',
      ),
      'mageworx-optionskupolicy-add-sku-policy-to-order' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\AddSkuPolicyToOrder',
      ),
    ...
    array (
      ...
      'stripe_pmme_minicart' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Checkout\\Block\\Cart\\Sidebar',
      ),
    ),
    ...
    array (
      ...
      'mageworx-optionskupolicy-avoid-setting-wrong-custom-price-for-excluded-item' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\AvoidSettingWrongCustomPriceForExcludedItem',
      ),
    ),
    ...
    array (
      ...
      'Amasty_CheckoutCore::CartTotalRepository' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Quote\\Model\\Cart\\CartTotalRepository',
      ),
      'stripeIntegration_cart_total_flat_fees' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Tax\\Plugin\\Quote\\Api\\CartTotalRepositoryPlugin',
      ),
    ),
    ...
    array (
      ...
      'Amasty_CheckoutCore::DataObjectHelper' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Framework\\Api\\DataObjectHelperPlugin',
      ),
    ),
    ...
    array (
      ...
      'stripe_order_payment' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Payment',
      ),
    ),
    ...
    array (
      ...
      'stripe_payments_filter_deregistered_invoice' => 
      array (
        'sortOrder' => 30,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\FilterRelatedObjects',
      ),
    ...
    array (
      ...
      'payment_services_save_guest_email' => 
      array (
        'sortOrder' => 0,
    ...
    array (
      'payment_services_order_cancellation' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Magento\\PaymentServicesPaypal\\Plugin\\OrderCancellation',
      ),
      'payment_services_order_update' => 
      array (
        'sortOrder' => 0,
    ...
    array (
      'payment_services_add_masked_quote_id_and_is_virtual_flag_to_customer_data' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Magento\\PaymentServicesPaypal\\Plugin\\Checkout\\CustomerData\\MaskedQuoteIdAndIsVirtualResolver',
      ),
    ...
    'Magento\\Vault\\Observer\\PaymentTokenAssigner' => 
    array (
      'payment_services_paypal_preserve_order_data' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Magento\\PaymentServicesPaypal\\Plugin\\Vault\\PaymentTokenAssignerPlugin',
      ),
    ),
    ...
    array (
      'Amasty_SeoRichData::Block_Breadcrumbs' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\SeoRichData\\Plugin\\Block\\Breadcrumbs',
      ),
    ),
    'Magento\\Review\\Block\\Product\\ReviewRenderer' => 
    array (
      'Amasty_SeoRichData::Block_Review' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\SeoRichData\\Plugin\\Microdata\\Replacer',
      ),
    ),
    'Magento\\Framework\\Pricing\\Render\\Amount' => 
    array (
      'Amasty_SeoRichData::Price_Amount' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\SeoRichData\\Plugin\\Microdata\\Replacer',
      ),
    ...
    array (
      'Amasty_SeoRichData::Product_Description' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\SeoRichData\\Plugin\\Microdata\\Replacer',
      ),
    ),
    'Yotpo\\Yotpo\\Block\\Yotpo' => 
    array (
      'Amasty_SeoRichData::Yotpo' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\SeoRichData\\Plugin\\Microdata\\Replacer',
      ),
    ...
    array (
      'platform_meta_data_v9' => 
      array (
        'sortOrder' => 0,
        'instance' => '\\Hyva\\Theme\\Plugin\\Platform\\AddPlatformMetaData',
      ),
    ),
    'Adyen\\Payment\\Helper\\PlatformInfo' => 
    array (
      'platform_meta_data_v10' => 
      array (
        'sortOrder' => 0,
        'instance' => '\\Hyva\\Theme\\Plugin\\Platform\\AddPlatformMetaData',
      ),
    ...
    array (
      'mageworx_optionbase_collect_product_option_conditions' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\CollectProductOptionConditions',
      ),
      'mageworx_optionbase_extend_option_collection' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ExtendOptionCollection',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Repository' => 
    array (
      'mageworx_optionbase_collect_enterprise_product_conditions' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\CollectEnterpriseProductConditions',
      ),
      'mageworx_optionbase_api-get-option-repository' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Api\\Product\\Option\\GetOptionAttributes',
      ),
      'mageworx_optionbase_api-set-option-repository' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Api\\Product\\Option\\SetOptionAttributes',
      ),
      'beforeDelete' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionLink\\Plugin\\BeforeDelete',
      ),
      'productScheduleOption' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\ProductScheduleOption',
      ),
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Value\\Collection' => 
    array (
      'mageworx_optionbase_extend_option_value_collection' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ExtendOptionValueCollection',
      ),
      'beforeLoad' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionLink\\Plugin\\BeforeLoad',
      ),
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options' => 
    array (
      'mageworx_optionbase_around_options_html' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\AroundOptionsHtml',
      ),
      'mageworx_optionadvancedpricing_extend_price_config' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionAdvancedPricing\\Plugin\\ExtendPriceConfig',
      ),
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\Select' => 
    array (
      'mageworx_optionbase_around_option_values_html' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\AroundOptionValuesHtml',
      ),
      'mageworx_optionbase_replace_option_type_select_template' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ChangeTemplateForOptionTypeSelect',
      ),
      'aroundGetValuesHtml' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSwatches\\Plugin\\Product\\View\\Options\\Type\\Select',
      ),
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\File' => 
    array (
      'mageworx_optionbase_replace_option_type_file' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ChangeTemplateForOptionTypeFile',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Type\\DefaultType' => 
    array (
      'mageworx_optionbase_validate_add_to_cart' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ValidateAddToCart',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Type\\AbstractType' => 
    array (
      'mageworx_optionbase_validate_cart_checkout' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ValidateCartCheckout',
      ),
      'mageworx_optionfeature_has_require_option' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AroundHasRequiredOptions',
      ),
    ),
    'Magento\\Framework\\Webapi\\ServiceInputProcessor' => 
    array (
      'mageworx_optionbase_api-serviceinputprocessor-replace-value-interface' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\ReplaceProductOptionValueInterface',
    ...
    array (
      'mageworx_optionadvancedpricing_add_price_type' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionAdvancedPricing\\Plugin\\AddPriceTypePlugin',
      ),
    ),
    'Magento\\Catalog\\Api\\Data\\ProductCustomOptionInterface' => 
    array (
      'mageworx_price_per_character_plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\OptionAdvancedPricing\\Plugin\\CalculatePricePerCharacterOptionPlugin',
      ),
      'mageworx_dynamic_options_get_option_price_plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\DynamicOptionsBase\\Plugin\\Catalog\\Product\\CalculateDynamicOptionsPlugin',
      ),
    ),
    'Magento\\Catalog\\Api\\ProductCustomOptionRepositoryInterface' => 
    array (
      'mageworx_dynamic_options_option_repository_plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\DynamicOptionsBase\\Plugin\\Catalog\\Product\\OptionRepositoryPlugin',
      ),
    ),
    'Magento\\Checkout\\Controller\\Cart\\Configure' => 
    array (
      'mageworx-optiondependency-checkout-cart-configure-quote-items' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionDependency\\Plugin\\CheckoutCartConfigureQuoteItems',
      ),
    ),
    'MageWorx\\OptionBase\\Helper\\Data' => 
    array (
      'mageworx_optioninventory_transfer_setting' => 
      array (
        'sortOrder' => 10,
        'instance' => 'MageWorx\\OptionInventory\\Plugin\\TransferSetting',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Type\\Price' => 
    array (
      'mageworx-optionfeatures-around-get-base-price' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AroundGetBasePrice',
      ),
    ),
    'Magento\\ConfigurableProduct\\Model\\Product\\Type\\Configurable\\Price' => 
    array (
      'mageworxOptionFeaturesSkipConfigurableOptionCalculation' => 
      array (
        'sortOrder' => 15,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\SkipConfigurableOptionCalculation',
      ),
    ),
    'MageWorx\\OptionBase\\Block\\Product\\View\\Options' => 
    array (
      'mageworx-optionfeatures-after-get-product-json-config' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AfterGetProductJsonConfig',
      ),
    ),
    'Magento\\Quote\\Model\\Quote\\Item' => 
    array (
      'mageworx-optionfeatures-around-compare-options' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\AroundCompareOptions',
      ),
    ),
    'Magento\\Checkout\\Model\\DefaultConfigProvider' => 
    array (
      'mageworx-optionfeatures-change-image-based-on-option-values' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\Checkout\\DefaultConfigProvider',
      ),
    ),
    'Magento\\Checkout\\Block\\Cart\\Item\\Renderer' => 
    array (
      'mageworx-optionfeatures-change-image-in-cart-based-on-option-values' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\Cart\\Item\\Renderer',
      ),
    ),
    'Magento\\Checkout\\CustomerData\\ItemPool' => 
    array (
      'mageworx-optionfeatures-change-image-in-cart-sidebar-based-on-option-values' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionFeatures\\Plugin\\Checkout\\CustomerData\\ItemPool',
      ),
    ),
    'Magento\\Catalog\\Ui\\DataProvider\\Product\\Form\\Modifier\\CustomOptions' => 
    array (
      'mageworx_optiontemplates_modifymeta' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionTemplates\\Plugin\\DuplicatePager',
      ),
    ),
    'Magento\\Catalog\\Api\\Data\\ProductCustomOptionValuesInterfaceFactory' => 
    array (
      'mageworx_optiontemplates_option_value_factory_resolver' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionTemplates\\Plugin\\OptionValueFactoryResolver',
      ),
    ),
    ...
    array (
      ...
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionLink\\Plugin\\BeforeSaveValues',
      ),
      'productScheduleOptionValue' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\ProductScheduleOptionValue',
      ),
    ),
    'Magento\\InventorySales\\Model\\IsProductSalableForRequestedQtyCondition\\IsSalableWithReservationsCondition' => 
    array (
      'mageworx-optionskupolicy-around-is-salable-with-reservations-condition' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\AroundIsSalableWithReservationsCondition',
      ),
    ),
    'Magento\\Quote\\Model\\Quote' => 
    array (
      'mageworx-optionskupolicy-fix-magento-add-to-cart' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\FixMagentoAddToCart',
      ),
      'mageworx-optionskupolicy-reorder-quote-items' => 
      array (
        'sortOrder' => 20,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\ReorderQuoteItems',
      ),
      'Amasty_CheckoutCore::Model_Quote' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Model\\QuotePlugin',
      ),
    ...
    array (
      'mageworx-optionskupolicy-skip-double-cart-item-processing' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\SkipDoubleCartItemProcessing',
      ),
    ),
    'Magento\\Directory\\Controller\\Currency\\SwitchAction' => 
    array (
      'mageworx-optionskupolicy-update-quote-items-currency-change' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\UpdateQuoteItemsOnCurrencyChange',
      ),
    ),
    ...
    array (
      'Amasty_CheckoutCore::PaymentModelInfo' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Payment\\Model\\Info',
      ),
    ),
    'Magento\\Payment\\Helper\\Data' => 
    array (
      'Amasty_CheckoutCore::PaymentHelperData' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Payment\\Helper\\Data',
      ),
    ),
    'Magento\\Sales\\Block\\Items\\AbstractItems' => 
    array (
      'Amasty_CheckoutCore::OrderInfo' => 
      array (
        'sortOrder' => 20,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Sales\\Block\\Items\\AbstractItems\\AddComment',
      ),
    ),
    'Magento\\Bundle\\Block\\Catalog\\Product\\View\\Type\\Bundle\\Option' => 
    array (
      'Amasty_CheckoutCore::Bundle_Option' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Block\\Catalog\\Product\\View\\Type\\Bundle\\OptionPlugin',
      ),
    ),
    'Magento\\Checkout\\CustomerData\\DirectoryData' => 
    array (
      'Amasty_CheckoutCore::DirectoryDataCache' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Checkout\\CustomerData\\DirectoryDataPlugin',
      ),
    ),
    'Magento\\Quote\\Api\\Data\\AddressInterface' => 
    array (
      'Amasty_CheckoutCore::FixExtensionAttributesType' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Quote\\AddressInterfacePlugin',
      ),
    ),
    'Magento\\Checkout\\Block\\Onepage' => 
    array (
      'Amasty_CheckoutCore::InitializeQuote' => 
      array (
        'sortOrder' => 40,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Checkout\\Block\\OnepagePlugin',
      ),
    ),
    'Magento\\AdvancedSalesRule\\Model\\Rule\\Condition\\FilterTextGenerator\\Address\\PaymentMethod' => 
    array (
      'Amasty_CheckoutCore::FixAdvancedSalesRules' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\AdvancedSalesRule\\Model\\Rule\\Condition\\FilterTextGenerator\\Address\\PaymentMethodPlugin',
      ),
    ),
    'Magento\\Quote\\Model\\QuoteRepository\\SaveHandler' => 
    array (
      'Amasty_CheckoutCore::saveCustomAddressFields' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Quote\\Model\\QuoteRepository\\SaveHandlerPlugin',
      ),
    ),
    'Magento\\Quote\\Model\\Quote\\Address\\CustomAttributeListInterface' => 
    array (
      'Amasty_CheckoutCore::registerCustomAttributes' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Quote\\Model\\Quote\\Address\\CustomAttributeListPlugin',
      ),
    ),
    'Magento\\Quote\\Model\\QuoteRepository\\LoadHandler' => 
    array (
      'Amasty_CheckoutCore::loadAddressAttributeValues' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Quote\\Model\\QuoteRepository\\LoadHandlerPlugin',
      ),
    ),
    'Amasty\\Gdpr\\Model\\Consent\\DataProvider\\CheckoutDataProvider' => 
    array (
      'Amasty_CheckoutCore::skipCountryRestriction' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Gdpr\\Model\\Consent\\DataProvider\\SkipCountryRestriction',
      ),
    ),
    ...
    array (
      'stripeIntegration_creditmemo_tax' => 
      array (
        'sortOrder' => 30,
        'instance' => 'StripeIntegration\\Tax\\Plugin\\Sales\\Model\\Order\\Creditmemo\\Total\\Tax',
      ),
    ),
    ...
    array (
      'stripe_creditmemo_service' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Service\\CreditmemoService',
      ),
    ),
    'Magento\\Sales\\Model\\ResourceModel\\Order\\Handler\\State' => 
    array (
      'stripe_order_state_resolver' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\StateResolver',
      ),
    ),
    ...
    array (
      'stripeBeforeAddToCartSubscriptionValidations' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Checkout\\Controller\\Cart\\Add',
      ),
    ),
    ...
    array (
      'stripe_payments_event_config' => 
      array (
        'sortOrder' => 10,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Framework\\Event\\Config',
      ),
    ),
    ...
    array (
      ...
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Checkout\\Block\\Cart\\Totals',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Payment\\Transaction\\ManagerInterface' => 
    array (
      'stripe_payment_transaction_manager' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Payment\\Transaction\\Manager',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\OrderIdentity' => 
    array (
      'stripe_subscription_order_email_identity' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Container\\OrderIdentity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\OrderSender' => 
    array (
      'stripe_subscription_order_email_sender' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Sender\\OrderSender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\InvoiceIdentity' => 
    array (
      'stripe_subscription_invoice_email_identity' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Container\\InvoiceIdentity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\InvoiceSender' => 
    array (
      'stripe_subscription_invoice_email_sender' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Sender\\InvoiceSender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\CreditmemoIdentity' => 
    array (
      'stripe_subscription_creditmemo_email_identity' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Container\\CreditmemoIdentity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\CreditmemoSender' => 
    array (
      'stripe_subscription_creditmemo_email_sender' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Sender\\CreditmemoSender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\ShipmentIdentity' => 
    array (
      'stripe_subscription_shipment_email_identity' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Container\\ShipmentIdentity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\ShipmentSender' => 
    array (
      'stripe_subscription_shipment_email_sender' => 
      array (
        'sortOrder' => 0,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Model\\Order\\Email\\Sender\\ShipmentSender',
      ),
    ),
    ...
    array (
      ...
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionDependency\\Plugin\\Adminhtml\\DuplicateDependency',
      ),
    ),
    ...
    array (
      ...
      'mageworx-optionskupolicy-move-quote-item' => 
      array (
        'sortOrder' => 20,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionSkuPolicy\\Plugin\\ValidateAdminMoveQuoteItem',
      ),
    ),
    ...
    array (
      ...
      'Amasty_CheckoutCore::MetadataForm' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Customer\\Metadata\\Form',
      ),
    ),
    ...
    array (
      ...
      'payments_services_transaction_amount_message' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Magento\\PaymentServicesPaypal\\Plugin\\OrderViewTransactionAmountMessage',
      ),
    ),
    ...
    array (
      'aroundDuplicateOption' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\AroundDuplicateOption',
      ),
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Value' => 
    array (
      'aroundDuplicateOptionValue' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\AroundDuplicateOptionValue',
      ),
    ),
    'Magento\\ConfigurableProduct\\Helper\\Product\\Options\\Loader' => 
    array (
      'mageworx_optionbase_escape_non_configurable_load' => 
      array (
        'sortOrder' => 1,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionBase\\Plugin\\Adminhtml\\EscapeNonConfigurableLoad',
      ),
    ),
    'MageWorx\\OptionTemplates\\Model\\Group\\Copier' => 
    array (
      'duplicateDependency' => 
      array (
        'sortOrder' => 1,
    ...
    array (
      'mageworx-optiondependency-admin-order-create-configure-quote-items' => 
      array (
        'sortOrder' => 10,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionDependency\\Plugin\\Adminhtml\\OrderCreateConfigureQuoteItems',
      ),
    ),
    'Magento\\AdvancedPricingImportExport\\Controller\\Adminhtml\\Export\\GetFilter' => 
    array (
      'mageworx-optionimportexport-use-default-export-product-filter' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\UseDefaultExportProductFilter',
      ),
    ),
    'Magento\\ImportExport\\Model\\Export\\Config' => 
    array (
      'mageworx-optionimportexport-extend-export-entities-config' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\ExtendExportEntitiesConfig',
      ),
    ),
    'Magento\\ImportExport\\Model\\Import\\Config' => 
    array (
      'mageworx-optionimportexport-extend-import-entities-config' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\ExtendImportEntitiesConfig',
      ),
    ),
    'Magento\\ImportExport\\Model\\ResourceModel\\Import\\Data' => 
    array (
      'mageworx-optionimportexport-skip-rows-for-import-mage-two' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\SkipRowsForImportMageTwo',
      ),
    ),
    'Magento\\CatalogImportExport\\Model\\Import\\Product\\Option' => 
    array (
      'mageworx-optionimportexport-set-product-import-flag' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\SetProductImportFlag',
      ),
    ),
    'Magento\\ImportExport\\Model\\Import\\Entity\\AbstractEntity' => 
    array (
      'mageworx-optionimportexport-set-import-validation-flag' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\SetImportValidationFlag',
      ),
    ),
    'Magento\\ImportExport\\Controller\\Adminhtml\\Export\\Export' => 
    array (
      'mageworx-optionimportexport-fix-export-controller' => 
      array (
        'sortOrder' => 5,
        'disabled' => false,
        'instance' => 'MageWorx\\OptionImportExport\\Plugin\\FixExportController',
      ),
    ),
    'Magento\\Config\\Block\\System\\Config\\Edit' => 
    array (
      'mageworx_searchsuiteautocomplete_config_promotion' => 
      array (
        'sortOrder' => 0,
        'instance' => 'MageWorx\\SearchSuiteAutocomplete\\Plugin\\AddPromotionToConfigPlugin',
      ),
    ),
    ...
    'Magento\\Sales\\Block\\Adminhtml\\Order\\Address\\Form' => 
    array (
      'Amasty_CheckoutCore::SalesOrderAddressForm' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Sales\\Admin\\Order\\Address\\Form',
      ),
    ),
    'Magento\\Config\\Block\\System\\Config\\Form' => 
    array (
      'Amasty_CheckoutCore::ExpanderBlockRenderer' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Config\\Block\\System\\Config\\FormPlugin',
      ),
    ),
    'Magento\\Customer\\Model\\Address\\DataProvider' => 
    array (
      'Amasty_CheckoutCore::CustomerAddressDataProvider' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Customer\\Address\\DataProvider',
      ),
    ),
    'Amasty\\Base\\Model\\ModuleInfoProvider' => 
    array (
      'Amasty_CheckoutCore::restrictModuleOSCInMenu' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Amasty\\CheckoutCore\\Plugin\\Base\\Model\\ModuleInfoProvider\\RestrictOSC',
      ),
    ),
    'Magento\\Sales\\Block\\Adminhtml\\Order\\Creditmemo\\View' => 
    array (
      'stripe_hide_pending_creditmemo_buttons' => 
      array (
        'sortOrder' => 10,
        'instance' => 'StripeIntegration\\Payments\\Plugin\\Sales\\Block\\Adminhtml\\Order\\Creditmemo\\View',
      ),
    ),
  ),
  1 => 
  array (
    ...
    'MageWorx\\OptionBase\\Ui\\DataProvider\\Product\\Form\\Modifier\\Pool' => NULL,
    'MageWorx\\OptionTemplates\\Ui\\DataProvider\\Group\\Form\\Modifier\\Pool' => NULL,
    'Magento\\Framework\\DB\\Adapter\\AdapterInterface' => 
    array (
      'execute_commit_callbacks' => 
      array (
    ...
    'Magento\\Payment\\Observer\\AbstractDataAssignObserver' => NULL,
    'Magento\\Vault\\Observer\\PaymentTokenAssigner' => 
    array (
      'payment_services_paypal_preserve_order_data' => 
      array (
    ...
    'Magento\\Framework\\Pricing\\Render\\AmountRenderInterface' => NULL,
    'Magento\\Framework\\Pricing\\Render\\Amount' => 
    array (
      'Amasty_SeoRichData::Price_Amount' => 
      array (
    ...
    'Magento\\Catalog\\Block\\Product\\View\\Options\\AbstractOptions' => NULL,
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\Select' => 
    array (
      'mageworx_optionbase_around_option_values_html' => 
      array (
    ...
    'Magento\\Catalog\\Model\\Config\\Source\\ProductPriceOptionsInterface' => NULL,
    'Magento\\Catalog\\Model\\Config\\Source\\Product\\Options\\Price' => 
    array (
      'mageworx_optionadvancedpricing_add_price_type' => 
      array (
    ...
    'Magento\\Quote\\Api\\Data\\CartItemInterface' => NULL,
    'Magento\\Quote\\Model\\Quote\\Item' => 
    array (
      'skip_async_order_check_data_no_deferred_stock_update' => 
      array (
    ...
    'Magento\\Checkout\\CustomerData\\ItemPoolInterface' => NULL,
    'Magento\\Checkout\\CustomerData\\ItemPool' => 
    array (
      'mageworx-optionfeatures-change-image-in-cart-sidebar-based-on-option-values' => 
      array (
    ...
    'Magento\\Catalog\\Api\\Data\\ProductCustomOptionValuesInterface' => NULL,
    'Magento\\Catalog\\Model\\Product\\Option\\Value' => 
    array (
      'productScheduleOptionValue' => 
      array (
    ...
    'Magento\\Quote\\Model\\Quote\\Item\\CartItemProcessorInterface' => NULL,
    'Magento\\Catalog\\Model\\CustomOptions\\CustomOptionProcessor' => 
    array (
      'mageworx-optionskupolicy-skip-double-cart-item-processing' => 
      array (
    ...
    'Magento\\Sales\\Model\\Order\\Creditmemo\\Total\\AbstractTotal' => NULL,
    'Magento\\Sales\\Model\\Order\\Creditmemo\\Total\\Tax' => 
    array (
      'stripeIntegration_creditmemo_tax' => 
      array (
    ...
    'Magento\\Sales\\Api\\CreditmemoManagementInterface' => NULL,
    'Magento\\Sales\\Model\\Service\\CreditmemoService' => 
    array (
      'stripe_creditmemo_service' => 
      array (
    ...
    'Magento\\ImportExport\\Model\\Export\\ConfigInterface' => NULL,
    'Magento\\ImportExport\\Model\\Export\\Config' => 
    array (
      'mageworx-optionimportexport-extend-export-entities-config' => 
      array (
    ...
    'Magento\\ImportExport\\Model\\Import\\ConfigInterface' => NULL,
    'Magento\\ImportExport\\Model\\Import\\Config' => 
    array (
      'mageworx-optionimportexport-extend-import-entities-config' => 
      array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        1 => 'Amasty_Base::AddEscaperToPhpRenderer',
      ),
    ),
    ...
    'Magento\\Framework\\App\\Response\\Http_setNoCacheHeaders___self' => 
    array (
      1 => 
      array (
        0 => 'hyva_theme',
    ...
    'Magento\\Framework\\Reflection\\MethodsMap_convertValue___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_api-methodsmap-replace-value-interface',
      ),
    ),
    'Magento\\Framework\\Reflection\\MethodsMap_getMethodsMap___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_api-methodsmap-replace-value-interface',
    ...
    'Magento\\ImportExport\\Model\\Import\\Entity\\AbstractEntity_validateData___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx-optionimportexport-set-import-validation-flag',
      ),
      4 => 
      array (
        0 => 'mageworx-optionimportexport-set-import-validation-flag',
    ...
    'Magento\\AdvancedPricingImportExport\\Model\\Import\\AdvancedPricing_validateData___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx-optionimportexport-set-import-validation-flag',
    ...
    array (
      1 => 
      array (
        0 => 'mageworx_dynamic_options_save_price_scope_plugin',
        1 => 'mp_smtp_config_plugin',
      ),
      4 => 
      array (
        0 => 'mageworx_dynamic_options_save_price_scope_plugin',
    ...
    array (
      2 => 'mageworx-optionimportexport-fix-stock-import',
    ),
    ...
    'Magento\\Catalog\\Model\\Product_afterSave___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optiontemplates_is_require_checker_aftersave',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        1 => 'mageworx-optionimportexport-set-import-entity-type',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Collection_addOptionsToResult___self' => 
    array (
      2 => 'mageworx_optionbase_collect_product_conditions',
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Collection_load___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_extend_product_collection',
      ),
    ),
    ...
    array (
      ...
      array (
        0 => 'configurableProductSaveOptions',
        1 => 'mageworx_optionbase_api-set-product-repository',
      ),
    ),
    'Magento\\Catalog\\Model\\ProductRepository_get___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionbase_api-get-product-repository',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\Product\\Option\\Type\\DefaultType_validateUserValue___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_validate_add_to_cart',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Type\\Select_validateUserValue___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_validate_add_to_cart',
    ...
    'Magento\\Catalog\\Model\\Product\\Option\\Type\\Select_getEditableOptionValue___self' => 
    array (
      2 => 'mageworx-optionfeatures-around-get-option-price',
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Type\\Select_getOptionPrice___self' => 
    array (
      2 => 'mageworx-optionfeatures-around-get-option-price',
    ),
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product_duplicate___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_dynamic_options_duplicate_plugin',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        3 => 'stripeBeforeCartRepositorySave',
      ),
    ),
    ...
    'Magento\\Quote\\Api\\Data\\AddressInterface_getExtensionAttributes___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::FixExtensionAttributesType',
      ),
    ),
    'Magento\\Quote\\Model\\Quote\\Address_getExtensionAttributes___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::FixExtensionAttributesType',
    ...
    array (
      2 => 'payment_services_order_cancellation',
    ),
    'Magento\\Quote\\Api\\CartManagementInterface_placeOrder_payment_services_order_cancellation' => 
    array (
      1 => 
      array (
        0 => 'payment_services_order_update',
      ),
    ...
    'Magento\\Quote\\Model\\QuoteManagement_placeOrder_payment_services_order_cancellation' => 
    array (
      1 => 
      array (
        0 => 'payment_services_order_update',
    ...
    array (
      ...
      array (
        ...
        1 => 'stripe_payments_quote_management',
        2 => 'validate_purchase_order_number',
        3 => 'mageworx-optionfeatures-add-qty-multiplier-to-order',
        4 => 'update_bundle_quote_item_options',
        5 => 'mageworx-optionskupolicy-add-sku-policy-to-order',
      ),
      4 => 
      array (
    ...
    'Magento\\Catalog\\Model\\Product\\Type\\AbstractType_checkProductBuyState___self' => 
    array (
      2 => 'mageworx_optionbase_validate_cart_checkout',
    ),
    'Magento\\Catalog\\Model\\Product\\Type\\AbstractType_hasRequiredOptions___self' => 
    array (
      2 => 'mageworx_optionfeature_has_require_option',
    ),
    ...
    'Magento\\GroupedProduct\\Model\\Product\\Type\\Grouped_checkProductBuyState___self' => 
    array (
      2 => 'mageworx_optionbase_validate_cart_checkout',
    ),
    'Magento\\GroupedProduct\\Model\\Product\\Type\\Grouped_hasRequiredOptions___self' => 
    array (
      2 => 'mageworx_optionfeature_has_require_option',
    ),
    ...
    'Magento\\Checkout\\Block\\Cart\\Sidebar_getJsLayout___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_pmme_minicart',
      ),
    ),
    ...
    'Magento\\Bundle\\Model\\ResourceModel\\Selection\\Collection_addOptionsToResult___self' => 
    array (
      2 => 'mageworx_optionbase_collect_product_conditions',
    ),
    ...
    'Magento\\ConfigurableProduct\\Model\\Product\\Type\\Configurable_checkProductBuyState___self' => 
    array (
      2 => 'mageworx_optionbase_validate_cart_checkout',
    ),
    'Magento\\ConfigurableProduct\\Model\\Product\\Type\\Configurable_hasRequiredOptions___self' => 
    array (
      2 => 'mageworx_optionfeature_has_require_option',
    ),
    ...
    'Magento\\Tax\\Model\\Sales\\Total\\Quote\\CommonTaxCollector_updateItemTaxInfo___self' => 
    array (
      2 => 'mageworx-optionskupolicy-avoid-setting-wrong-custom-price-for-excluded-item',
    ),
    ...
    array (
      ...
      array (
        ...
        2 => 'Amasty_CheckoutCore::CartTotalRepository',
        3 => 'stripeIntegration_cart_total_flat_fees',
      ),
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::CartTotalRepository',
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::DataObjectHelper',
      ),
    ),
    ...
    'Magento\\Sales\\Api\\Data\\OrderPaymentInterface_canVoid___self' => 
    array (
      2 => 'stripe_order_payment',
    ),
    ...
    'Magento\\Sales\\Model\\Order_getRelatedObjects___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_payments_filter_deregistered_invoice',
      ),
    ),
    ...
    'Magento\\Sales\\Model\\Order\\Payment_canVoid___self' => 
    array (
      2 => 'stripe_order_payment',
    ),
    ...
    array (
      4 => 
      array (
        0 => 'payment_services_save_guest_email',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        1 => 'mageworx_optionbase_extend_product_collection',
      ),
    ),
    'Magento\\ConfigurableProduct\\Model\\ResourceModel\\Product\\Type\\Configurable\\Product\\Collection_addOptionsToResult___self' => 
    array (
      2 => 'mageworx_optionbase_collect_product_conditions',
    ),
    ...
    array (
      4 => 
      array (
        0 => 'payment_services_add_masked_quote_id_and_is_virtual_flag_to_customer_data',
        1 => 'braintreeAddMaskedIdToCartData',
        2 => 'customerdata.cart',
        3 => 'vendor_module_add_cart_data',
      ),
    ),
    'Magento\\Vault\\Observer\\PaymentTokenAssigner_execute___self' => 
    array (
      2 => 'payment_services_paypal_preserve_order_data',
    ),
    ...
    'Magento\\Theme\\Block\\Html\\Breadcrumbs_assign___self' => 
    array (
      1 => 
      array (
        0 => 'Amasty_SeoRichData::Block_Breadcrumbs',
      ),
    ),
    'Magento\\Theme\\Block\\Html\\Breadcrumbs_toHtml___self' => 
    array (
      1 => 
      array (
        0 => 'Amasty_SeoRichData::Block_Breadcrumbs',
    ...
    array (
      4 => 
      array (
        0 => 'Amasty_SeoRichData::Block_Review',
      ),
    ),
    'Magento\\Framework\\Pricing\\Render\\Amount_toHtml___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_SeoRichData::Price_Amount',
      ),
    ),
    'Magento\\Theme\\Block\\Html\\Title_toHtml___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_SeoRichData::Html_Title',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'Amasty_SeoRichData::Product_Description',
      ),
    ),
    'Yotpo\\Yotpo\\Block\\Yotpo_toHtml___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_SeoRichData::Yotpo',
      ),
    ),
    ...
    'Magento\\Framework\\Module\\Status_setIsEnabled___self' => 
    array (
      4 => 
      array (
        0 => 'hyva_theme_module_status',
      ),
    ),
    ...
    'Adyen\\Payment\\Helper\\Data_getModuleName___self' => 
    array (
      4 => 
      array (
        0 => 'platform_meta_data_v9',
      ),
    ),
    'Adyen\\Payment\\Helper\\PlatformInfo_getModuleName___self' => 
    array (
      4 => 
      array (
        0 => 'platform_meta_data_v10',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Collection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Collection_getProductOptions___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_collect_product_option_conditions',
      ),
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Collection_addValuesToResult___self' => 
    array (
      2 => 'mageworx_optionbase_collect_product_option_conditions',
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Collection_load___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_extend_option_collection',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'mageworx_dynamic_options_option_repository_plugin',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\Product\\Option\\Repository_save___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_dynamic_options_option_repository_plugin',
        1 => 'mageworx_optionbase_api-set-option-repository',
      ),
      1 => 
      array (
        0 => 'productScheduleOption',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Repository_delete___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_dynamic_options_option_repository_plugin',
    ...
    'Magento\\Catalog\\Model\\Product\\Option\\Repository_getProductOptions___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_collect_enterprise_product_conditions',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Repository_getList___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionbase_api-get-option-repository',
      ),
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Repository_get___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionbase_api-get-option-repository',
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Value\\Collection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Value\\Collection_load___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_extend_option_value_collection',
        1 => 'beforeLoad',
      ),
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options_getOptionHtml___self' => 
    array (
      2 => 'mageworx_optionbase_around_options_html',
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options_getJsonConfig___self' => 
    array (
      2 => 'mageworx_optionadvancedpricing_extend_price_config',
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\Select_getValuesHtml___self' => 
    array (
      2 => 'mageworx_optionbase_around_option_values_html',
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\Select_getTemplate___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionbase_replace_option_type_select_template',
      ),
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\Select_getValuesHtml_mageworx_optionbase_around_option_values_html' => 
    array (
      2 => 'aroundGetValuesHtml',
    ),
    'Magento\\Catalog\\Block\\Product\\View\\Options\\Type\\File_getTemplate___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionbase_replace_option_type_file',
      ),
    ),
    'Magento\\Framework\\Webapi\\ServiceInputProcessor_convertValue___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_api-serviceinputprocessor-replace-value-interface',
      ),
    ),
    'Magento\\Framework\\Webapi\\ServiceInputProcessor_getMethodsMap___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx_optionbase_api-serviceinputprocessor-replace-value-interface',
    ...
    'Magento\\Catalog\\Model\\Config\\Source\\Product\\Options\\Price_toOptionArray___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionadvancedpricing_add_price_type',
      ),
    ),
    'Magento\\Catalog\\Model\\Config\\Source\\Product\\Options\\Price_prefixesToOptionArray___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optionadvancedpricing_add_price_type',
    ...
    'Magento\\Catalog\\Api\\Data\\ProductCustomOptionInterface_getPrice___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_price_per_character_plugin',
        1 => 'mageworx_dynamic_options_get_option_price_plugin',
      ),
    ),
    ...
    'Magento\\Checkout\\Controller\\Cart\\Configure_execute___self' => 
    array (
      1 => 
      array (
        0 => 'designLoader',
      ...
      2 => 'mageworx-optiondependency-checkout-cart-configure-quote-items',
    ),
    'MageWorx\\OptionBase\\Helper\\Data_isHiddenOutOfStockOptions___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optioninventory_transfer_setting',
      ),
    ),
    'MageWorx\\OptionBase\\Helper\\Data_isDisabledOutOfStockOptions___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optioninventory_transfer_setting',
    ...
    'Magento\\Catalog\\Model\\Product\\Type\\Price_getFinalPrice___self' => 
    array (
      2 => 'mageworx-optionfeatures-around-get-base-price',
    ),
    'Magento\\ConfigurableProduct\\Model\\Product\\Type\\Configurable\\Price_getFinalPrice___self' => 
    array (
      2 => 'mageworx-optionfeatures-around-get-base-price',
    ),
    'Magento\\ConfigurableProduct\\Model\\Product\\Type\\Configurable\\Price_getFinalPrice_mageworx-optionfeatures-around-get-base-price' => 
    array (
      2 => 'mageworxOptionFeaturesSkipConfigurableOptionCalculation',
    ),
    'MageWorx\\OptionBase\\Block\\Product\\View\\Options_getOptionHtml___self' => 
    array (
      2 => 'mageworx_optionbase_around_options_html',
    ),
    'MageWorx\\OptionBase\\Block\\Product\\View\\Options_getJsonConfig___self' => 
    array (
      2 => 'mageworx_optionadvancedpricing_extend_price_config',
    ),
    'MageWorx\\OptionBase\\Block\\Product\\View\\Options_getProductJsonConfig___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx-optionfeatures-after-get-product-json-config',
      ),
    ),
    'Magento\\Quote\\Model\\Quote\\Item_checkData___self' => 
    array (
      2 => 'skip_async_order_check_data_no_deferred_stock_update',
    ),
    'Magento\\Quote\\Model\\Quote\\Item_compareOptions___self' => 
    array (
      2 => 'mageworx-optionfeatures-around-compare-options',
    ),
    'Magento\\Checkout\\Model\\DefaultConfigProvider_getConfig___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx-optionfeatures-change-image-based-on-option-values',
      ),
    ),
    'Magento\\Checkout\\Block\\Cart\\Item\\Renderer_getImage___self' => 
    array (
      2 => 'mageworx-optionfeatures-change-image-in-cart-based-on-option-values',
    ),
    'Magento\\Checkout\\CustomerData\\ItemPool_getItemData___self' => 
    array (
      2 => 'mageworx-optionfeatures-change-image-in-cart-sidebar-based-on-option-values',
    ),
    'Magento\\Catalog\\Ui\\DataProvider\\Product\\Form\\Modifier\\CustomOptions_modifyMeta___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_optiontemplates_modifymeta',
      ),
    ),
    'Magento\\Catalog\\Api\\Data\\ProductCustomOptionValuesInterfaceFactory_create___self' => 
    array (
      2 => 'mageworx_optiontemplates_option_value_factory_resolver',
    ),
    'Magento\\Catalog\\Model\\Product\\Option\\Value_saveValues___self' => 
    array (
      1 => 
      array (
        0 => 'productScheduleOptionValue',
        1 => 'beforeSaveValues',
      ),
    ),
    'Magento\\InventorySales\\Model\\IsProductSalableForRequestedQtyCondition\\IsSalableWithReservationsCondition_execute___self' => 
    array (
      2 => 'mageworx-optionskupolicy-around-is-salable-with-reservations-condition',
    ),
    'Magento\\Quote\\Model\\Quote_setShippingAddress___self' => 
    array (
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::Model_Quote',
      ),
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::Model_Quote',
    ...
    array (
      2 => 'mageworx-optionskupolicy-fix-magento-add-to-cart',
    ),
    'Magento\\Quote\\Model\\Quote_getAllItems___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx-optionskupolicy-reorder-quote-items',
      ),
    ),
    'Magento\\Catalog\\Model\\CustomOptions\\CustomOptionProcessor_convertToBuyRequest___self' => 
    array (
      2 => 'mageworx-optionskupolicy-skip-double-cart-item-processing',
    ),
    ...
    array (
      ...
      2 => 'mageworx-optionskupolicy-update-quote-items-currency-change',
    ),
    ...
    'Magento\\Payment\\Model\\Info_setAdditionalInformation___self' => 
    array (
      2 => 'Amasty_CheckoutCore::PaymentModelInfo',
    ),
    'Magento\\Payment\\Helper\\Data_getPaymentMethodList___self' => 
    array (
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::PaymentHelperData',
      ),
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::PaymentHelperData',
    ...
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::OrderInfo',
      ),
    ),
    ...
    array (
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::Bundle_Option',
      ),
    ),
    'Magento\\Checkout\\CustomerData\\DirectoryData_getSectionData___self' => 
    array (
      2 => 'Amasty_CheckoutCore::DirectoryDataCache',
    ),
    'Magento\\Checkout\\Block\\Onepage_getJsLayout___self' => 
    array (
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::InitializeQuote',
      ),
    ),
    ...
    array (
      1 => 
      array (
        0 => 'Amasty_CheckoutCore::FixAdvancedSalesRules',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::saveCustomAddressFields',
      ),
    ),
    'Magento\\Quote\\Model\\Quote\\Address\\CustomAttributeListInterface_getAttributes___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::registerCustomAttributes',
      ),
    ),
    'Magento\\Quote\\Model\\QuoteRepository\\LoadHandler_load___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::loadAddressAttributeValues',
      ),
    ),
    'Amasty\\Gdpr\\Model\\Consent\\DataProvider\\CheckoutDataProvider_isNeedShowConsentByCountry___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::skipCountryRestriction',
      ),
    ),
    ...
    'Magento\\Tax\\Model\\Sales\\Total\\Quote\\Tax_updateItemTaxInfo___self' => 
    array (
      2 => 'mageworx-optionskupolicy-avoid-setting-wrong-custom-price-for-excluded-item',
    ),
    ...
    'Magento\\Tax\\Model\\Config_applyTaxAfterDiscount___self' => 
    array (
      4 => 
      array (
        0 => 'stripeIntegration_model_config',
    ...
    'Magento\\Sales\\Model\\Order\\Creditmemo\\Total\\Tax_collect___self' => 
    array (
      4 => 
      array (
        0 => 'stripeIntegration_creditmemo_tax',
      ),
    ),
    ...
    'Magento\\Sales\\Model\\Service\\CreditmemoService_refund___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_creditmemo_service',
      ),
      4 => 
      array (
        0 => 'stripe_creditmemo_service',
    ...
    'Magento\\Sales\\Model\\ResourceModel\\Order\\Handler\\State_check___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_order_state_resolver',
      ),
      4 => 
      array (
        0 => 'stripe_order_state_resolver',
    ...
    array (
      ...
      4 => 
      array (
        0 => 'stripeBeforeAddToCartSubscriptionValidations',
      ),
    ),
    ...
    'Magento\\Framework\\Event\\ConfigInterface_getObservers___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_payments_event_config',
      ),
    ),
    'Magento\\Checkout\\Block\\Cart\\Totals_getJsLayout___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_pmme_cart',
    ...
    'Magento\\Sales\\Model\\Order\\Payment\\Transaction\\ManagerInterface_getAuthorizationTransaction___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_payment_transaction_manager',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\Container_isEnabled___self' => 
    array (
      4 => 
      array (
        0 => 'applyStoreEmailConfigToSalesEmail',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Container\\OrderIdentity_getTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_order_email_identity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\OrderIdentity_getGuestTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_order_email_identity',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\OrderSender_send___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_subscription_order_email_sender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\InvoiceIdentity_isEnabled___self' => 
    array (
      4 => 
      array (
        0 => 'applyStoreEmailConfigToSalesEmail',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Container\\InvoiceIdentity_getTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_invoice_email_identity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\InvoiceIdentity_getGuestTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_invoice_email_identity',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\InvoiceSender_send___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_subscription_invoice_email_sender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\CreditmemoIdentity_isEnabled___self' => 
    array (
      4 => 
      array (
        0 => 'applyStoreEmailConfigToSalesEmail',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Container\\CreditmemoIdentity_getTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_creditmemo_email_identity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\CreditmemoIdentity_getGuestTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_creditmemo_email_identity',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\CreditmemoSender_send___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_subscription_creditmemo_email_sender',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\ShipmentIdentity_isEnabled___self' => 
    array (
      4 => 
      array (
        0 => 'applyStoreEmailConfigToSalesEmail',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Container\\ShipmentIdentity_getTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_shipment_email_identity',
      ),
    ),
    'Magento\\Sales\\Model\\Order\\Email\\Container\\ShipmentIdentity_getGuestTemplateId___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_subscription_shipment_email_identity',
    ...
    'Magento\\Sales\\Model\\Order\\Email\\Sender\\ShipmentSender_send___self' => 
    array (
      1 => 
      array (
        0 => 'stripe_subscription_shipment_email_sender',
      ),
    ),
    ...
    'Magento\\Sales\\Model\\AdminOrder\\Create_moveQuoteItem___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx-optionskupolicy-move-quote-item',
      ),
    ),
    ...
    'Magento\\Customer\\Model\\Metadata\\Form_getAttributes___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::MetadataForm',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        4 => 'payments_services_transaction_amount_message',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option_duplicate___self' => 
    array (
      2 => 'aroundDuplicateOption',
    ),
    'Magento\\Catalog\\Model\\ResourceModel\\Product\\Option\\Value_duplicate___self' => 
    array (
      2 => 'aroundDuplicateOptionValue',
    ),
    'Magento\\ConfigurableProduct\\Helper\\Product\\Options\\Loader_load___self' => 
    array (
      2 => 'mageworx_optionbase_escape_non_configurable_load',
    ),
    'MageWorx\\OptionTemplates\\Model\\Group\\Copier_copy___self' => 
    array (
      2 => 'duplicateDependency',
    ),
    'Magento\\Sales\\Controller\\Adminhtml\\Order\\Create\\ConfigureQuoteItems_execute___self' => 
    array (
      1 => 
      array (
        0 => 'designLoader',
      ...
      2 => 'mageworx-optiondependency-admin-order-create-configure-quote-items',
    ),
    'Magento\\Sales\\Controller\\Adminhtml\\Order\\Create\\ConfigureQuoteItems_dispatch___self' => 
    array (
      1 => 
      array (
        0 => 'adminMassactionKey',
    ...
    'Magento\\Sales\\Controller\\Adminhtml\\Order\\Create\\ConfigureQuoteItems_dispatch_adminAuthentication' => 
    array (
      1 => 
      array (
        0 => 'adminLoadDesign',
    ...
    'Magento\\AdvancedPricingImportExport\\Controller\\Adminhtml\\Export\\GetFilter_execute___self' => 
    array (
      1 => 
      array (
        0 => 'designLoader',
        1 => 'customerNotification',
        2 => 'themeRegistrationFromFilesystem',
        3 => 'mageworx-optionimportexport-use-default-export-product-filter',
      ),
    ),
    'Magento\\AdvancedPricingImportExport\\Controller\\Adminhtml\\Export\\GetFilter_dispatch___self' => 
    array (
      1 => 
      array (
        0 => 'adminMassactionKey',
    ...
    'Magento\\AdvancedPricingImportExport\\Controller\\Adminhtml\\Export\\GetFilter_dispatch_adminAuthentication' => 
    array (
      1 => 
      array (
        0 => 'adminLoadDesign',
    ...
    'Magento\\ImportExport\\Model\\Export\\Config_getEntities___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx-optionimportexport-extend-export-entities-config',
      ),
    ),
    'Magento\\ImportExport\\Model\\Import\\Config_getEntities___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx-optionimportexport-extend-import-entities-config',
      ),
    ),
    'Magento\\ImportExport\\Model\\ResourceModel\\Import\\Data_getNextBunch___self' => 
    array (
      2 => 'mageworx-optionimportexport-skip-rows-for-import-mage-two',
    ),
    'Magento\\CatalogImportExport\\Model\\Import\\Product\\Option_isNeedToLogInHistory___self' => 
    array (
      4 => 
      array (
        0 => 'SourceNeedToLogin',
    ...
    'Magento\\CatalogImportExport\\Model\\Import\\Product\\Option_validateData___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx-optionimportexport-set-import-validation-flag',
    ...
    'Magento\\CatalogImportExport\\Model\\Import\\Product\\Option_importData___self' => 
    array (
      1 => 
      array (
        0 => 'mageworx-optionimportexport-set-product-import-flag',
      ),
      4 => 
      array (
        0 => 'mageworx-optionimportexport-set-product-import-flag',
    ...
    array (
      ...
      2 => 'mageworx-optionimportexport-fix-export-controller',
    ),
    ...
    'Magento\\Config\\Block\\System\\Config\\Edit_toHtml___self' => 
    array (
      4 => 
      array (
        0 => 'mageworx_searchsuiteautocomplete_config_promotion',
      ),
    ),
    ...
    'Magento\\Sales\\Block\\Adminhtml\\Order\\Address\\Form_getFormValues___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::SalesOrderAddressForm',
      ),
    ),
    'Magento\\Config\\Block\\System\\Config\\Form_getForm___self' => 
    array (
      4 => 
      array (
        0 => 'remove_password_and_user_confirmation_form_fields',
    ...
    'Magento\\Config\\Block\\System\\Config\\Form_toHtml___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::ExpanderBlockRenderer',
      ),
    ),
    'Magento\\Customer\\Model\\Address\\DataProvider_getMeta___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::CustomerAddressDataProvider',
      ),
    ),
    'Amasty\\Base\\Model\\ModuleInfoProvider_getRestrictedModules___self' => 
    array (
      4 => 
      array (
        0 => 'Amasty_CheckoutCore::restrictModuleOSCInMenu',
      ),
    ),
    'Magento\\Sales\\Block\\Adminhtml\\Order\\Creditmemo\\View_setLayout___self' => 
    array (
      4 => 
      array (
        0 => 'stripe_hide_pending_creditmemo_buttons',
      ),
    ),
  ),
);